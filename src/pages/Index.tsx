      ...
      <section className="pt-20 pb-12 px-3 sm:px-6 lg:px-8">
        <div className="container mx-auto text-center max-w-6xl">
          <div className="max-w-4xl mx-auto">
            <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-foreground mb-4 sm:mb-6 leading-tight my-[8px] py-[18px] text-center px-[11px] lg:text-5xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center mb-8 sm:mb-12 px-2 sm:px-0">
              <Button variant="cta" size="lg" onClick={scrollToForm} className="w-full sm:w-auto min-h-[44px]">
                Get My Custom Growth Plan
              </Button>
            </div>
            <div className="flex justify-center px-2 sm:px-0">
              <img src={heroClientLogos} alt="Hero Client Logo Collage" className="rounded-lg shadow-elevated w-full max-w-full sm:max-w-xl md:max-w-2xl" />
            </div>
          </div>
        </div>
      </section>
