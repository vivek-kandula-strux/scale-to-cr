...
const NotFound = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Page Not Found - Strux Digital</title>
        <meta name="description" content="Sorry, the page you're looking for doesn't exist. Return to Strux Digital's homepage to explore our business growth solutions." />
